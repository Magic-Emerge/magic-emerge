...
export default function Login() {
  ...
  const handleOnRegister = (val: Boolean) => {
    if (val) {
  ...
  return (
    <main className="flex relative overflow-hidden h-screen w-full  bg-blue-primary">
      ...
      <div className="z-10 w-full flex-col items-center justify-center text-sm flex">
        <span className="mb-10 font-sans text-2xl text-white font-medium tracking-[1px] leading-[45px]">
          欢迎登录 Magic Emerge!
        </span>
